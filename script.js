...
// ✅ Allow only steps 1-3 to be accessed manually
...
document.getElementById("multiStepForm").addEventListener("submit", async function (e) {
  ...
  data.teachers = [...form.querySelectorAll('input[name="teachers[]"]')].map(i => i.value);
  data.subjects = [...form.querySelectorAll('input[name="subjects[]"]')].map(i => i.value);
